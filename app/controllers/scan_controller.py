...
# تم إضافة AuthError هنا لتجنب خطأ الـ 500
from app.utils.error_handler import handle_errors, AppError, ValidationError, AuthError
from app.utils.response import success_response
from app.utils.jwt import decode_token, JWTError

# ==========================================
# === 1. بناء الموديل وتحميل الأوزان ===
# ==========================================
...
try:
    # 1. بناء الموديل فارغاً
    cnn_model = build_alzheimer_model()

    # 2. تحميل الأوزان فقط (by_name=True مهمة جداً عشان يتجاهل أي اختلاف في الـ Config)
...
# ==========================================
# === 2. إعدادات Gemini API للتوليد الطبي ===
# ==========================================
...
# ==========================================
# === 3. الدالة الرئيسية لتحليل الأشعة =======
# ==========================================
...
def analyze_mri_scan():
    ...
    try:
        ...
        # استقبال اللغة من الـ Request (لو مفيش يعتبره عربي كافتراضي)
