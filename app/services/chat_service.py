"""Chat Service — Business logic for AI chatbot operations (text & voice)."""
...
from app.utils.error_handler import AppError, ValidationError
...
try:
    ...
    print(f"[WARN] Some ML imports failed: {_e}")
...
def ask_text(patient_id: str, data: dict):
...
def ask_voice(patient_id: str, audio_file):
